<?php
	class Group_send extends Base_Controller {

		function __construct()
		{
			parent::__construct();
			$this->load->model('group_send_model', 'gs');
		}
		...
		public function group_send_list()
		{
			if ($this->access->is_admin())
			{
				$data['list'] = $this->gs->get_info();
			}
			else
			{
				$data['list'] = $this->gs->get_info(NULL, $this->Global_user_id);
			}
