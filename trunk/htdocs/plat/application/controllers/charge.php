<?php
	class Charge extends Base_Controller {
		...
		public function charge_list()
		{
			...
			{
				$data['list'] = $this->charge->get_info();
			}
			else
			{
				$data['list'] = $this->charge->get_info(NULL, $this->Global_user_id);
			}

			$this->load->view('charge_list_view', $data);
		}

		public function let_me_charge()
		{
			echo '网站建设中';
			exit;
